...
pub(crate) fn draw_task_panel_inline(ui: &mut egui::Ui, gui: &mut GuiState) -> bool {
...

    {
        ...
        match &mut task {
            ActiveTask::Box {
                ...
                egui::Grid::new("task_box")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "Width");
                        pmm!(ui, width, 0.1..=1000.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Height");
                        pmm!(ui, height, 0.1..=1000.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Depth");
                        pmm!(ui, depth, 0.1..=1000.0, 0.5, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::Cylinder { radius, height, .. } => {
                theme::draw_task_section(ui, "Parameters");
                egui::Grid::new("task_cyl")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "Radius");
                        pmm!(ui, radius, 0.1..=500.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Height");
                        pmm!(ui, height, 0.1..=1000.0, 0.5, changed);
                        ui.end_row();
            ...
            ActiveTask::Cone {
                ...
                theme::draw_task_section(ui, "Parameters");
                egui::Grid::new("task_cone")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "Base Radius");
                        pmm!(ui, base_radius, 0.01..=500.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Top Radius");
                        pmm!(ui, top_radius, 0.0..=500.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Height");
                        pmm!(ui, height, 0.1..=1000.0, 0.5, changed);
                        ui.end_row();
            ...
            ActiveTask::Torus {
                ...
                theme::draw_task_section(ui, "Parameters");
                egui::Grid::new("task_tor")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "Major Radius");
                        pmm!(ui, major_radius, 0.1..=500.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Minor Radius");
                        pmm!(ui, minor_radius, 0.01..=200.0, 0.1, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::Tube {
                ...
                theme::draw_task_section(ui, "Parameters");
                egui::Grid::new("task_tube")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "Outer Radius");
                        pmm!(ui, outer_radius, 0.1..=500.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Inner Radius");
                        pmm!(ui, inner_radius, 0.01..=499.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Height");
                        pmm!(ui, height, 0.1..=1000.0, 0.5, changed);
                        ui.end_row();
            ...
            ActiveTask::Prism {
                ...
                egui::Grid::new("task_prism")
                    ...
                    .show(ui, |ui| {
                        ...
                        if ui
                            .add(
                                egui::DragValue::new(&mut sides_f)
                                    .range(3.0..=100.0)
                                    .speed(0.2),
                            )
                            .changed()
            ...
            ActiveTask::Wedge {
                ...
                egui::Grid::new("task_wedge")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "DX");
                        pmm!(ui, dx, 0.1..=1000.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "DY");
                        pmm!(ui, dy, 0.1..=1000.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "DZ");
                        pmm!(ui, dz, 0.1..=1000.0, 0.5, changed);
                        ui.end_row();
                    });
                theme::draw_task_section(ui, "Top Dimensions");
                egui::Grid::new("task_wedge2")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "DX2");
                        pmm!(ui, dx2, 0.0..=1000.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "DY2");
                        pmm!(ui, dy2, 0.0..=1000.0, 0.5, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::Ellipsoid { rx, ry, rz, .. } => {
                theme::draw_task_section(ui, "Radii");
                egui::Grid::new("task_ellip")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "RX");
                        pmm!(ui, rx, 0.1..=500.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "RY");
                        pmm!(ui, ry, 0.1..=500.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "RZ");
                        pmm!(ui, rz, 0.1..=500.0, 0.5, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::Helix {
                ...
                egui::Grid::new("task_helix")
                    ...
                    .show(ui, |ui| {
                        ...
                        ui.end_row();
                        plabel!(ui, "Pitch");
                        pmm!(ui, pitch, 0.1..=200.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Turns");
                        pval!(ui, turns, 0.5..=50.0, 0.1, changed);
                        ui.end_row();
                        plabel!(ui, "Tube Radius");
                        pmm!(ui, tube_radius, 0.01..=50.0, 0.1, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::Pad {
            ...
            ActiveTask::Pocket {
                ...
                egui::Grid::new("task_pocket")
                    ...
                    .show(ui, |ui| {
                        ...
                        pmm!(ui, depth, 0.1..=1000.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Through All");
                        changed |= ui.checkbox(through_all, "").changed();
                        ui.end_row();
                    });
            }
            ActiveTask::Revolve {
            ...
            ActiveTask::Hole {
                ...
                egui::Grid::new("task_hole")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "Radius");
                        pmm!(ui, radius, 0.01..=200.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Depth");
                        pmm!(ui, depth, 0.1..=1000.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Countersink");
                        changed |= ui.checkbox(countersink, "").changed();
                        ui.end_row();
                        if *countersink {
                            plabel!(ui, "CS Angle");
                ...
                egui::Grid::new("task_fillet")
                    ...
                    .show(ui, |ui| {
                        if edge_count > 0 {
                            plabel!(ui, "Edges");
                            ui.label(
                                egui::RichText::new(format!("{edge_count} selected"))
                                    .size(11.0)
                        ...
                        plabel!(ui, "Radius");
                        pmm!(ui, radius, 0.01..=100.0, 0.1, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::Chamfer { distance, .. } => {
                ...
                egui::Grid::new("task_chamfer")
                    ...
                    .show(ui, |ui| {
                        ...
                        plabel!(ui, "Distance");
                        pmm!(ui, distance, 0.01..=100.0, 0.1, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::Shell { thickness, .. } => {
                theme::draw_task_section(ui, "Shell");
                egui::Grid::new("task_shell")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "Thickness");
            ...
            ActiveTask::MirrorOp { plane, .. } => {
                ...
                egui::Grid::new("task_mirror")
                    ...
                    .show(ui, |ui| {
                        ...
                        if ui
                            .add(
                                egui::DragValue::new(&mut plane_f)
                                    .range(0.0..=2.0)
                                    .speed(0.1)
                                    .custom_formatter(|v, _| labels[v as usize % 3].to_string()),
                            )
                            .changed()
                        {
                            *plane = plane_f as u8;
            ...
            ActiveTask::Pattern {
                ...
                egui::Grid::new("task_pattern")
                    ...
                    .show(ui, |ui| {
                        ...
                        if ui
                            .add(
                                egui::DragValue::new(&mut count_f)
                                    .range(2.0..=100.0)
                                    .speed(0.2),
                            )
                            .changed()
                        ...
                        ui.end_row();
                        plabel!(ui, "Spacing");
                        pmm!(ui, spacing, 0.1..=500.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Axis");
                        let labels = ["X", "Y", "Z"];
                        let mut axis_f = *axis as f64;
            ...
            ActiveTask::Sprocket {
                ...
                egui::Grid::new("task_sprocket")
                    ...
                    .show(ui, |ui| {
                        ...
                        if ui
                            .add(
                                egui::DragValue::new(&mut teeth_f)
                                    .range(4.0..=200.0)
                                    .speed(0.5),
                            )
                            .changed()
                        ...
                        ui.end_row();
                        plabel!(ui, "Roller Dia");
                        pmm!(ui, roller_diameter, 0.1..=50.0, 0.1, changed);
                        ui.end_row();
                        plabel!(ui, "Pitch");
                        pmm!(ui, pitch, 0.1..=100.0, 0.1, changed);
                        ui.end_row();
                        plabel!(ui, "Bore");
                        pmm!(ui, bore, 0.1..=100.0, 0.1, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::InvoluteGear {
                teeth,
                module_val,
                pressure_angle,
                ..
                ...
                egui::Grid::new("task_gear")
                    ...
                    .show(ui, |ui| {
                        ...
                        ui.end_row();
                        plabel!(ui, "Module");
                        pval!(ui, module_val, 0.1..=50.0, 0.1, changed);
                        ui.end_row();
                        plabel!(ui, "Pressure Angle");
                        pdeg!(ui, pressure_angle, 10.0..=30.0, 0.5, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::DraftLine { length, angle, .. } => {
                theme::draw_task_section(ui, "Line");
                egui::Grid::new("task_dline")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "Length");
                        pmm!(ui, length, 0.1..=1000.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Angle");
                        pdeg!(ui, angle, 0.0..=360.0, 1.0, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::DraftCircle { radius, .. } => {
                theme::draw_task_section(ui, "Circle");
                egui::Grid::new("task_dcirc")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "Radius");
            ...
            ActiveTask::DraftArc {
                ...
                egui::Grid::new("task_darc")
                    ...
                    .show(ui, |ui| {
                        ...
                        ui.end_row();
                        plabel!(ui, "Start");
                        pdeg!(ui, start_angle, 0.0..=360.0, 1.0, changed);
                        ui.end_row();
                        plabel!(ui, "End");
                        pdeg!(ui, end_angle, 0.0..=360.0, 1.0, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::DraftEllipse { rx, ry, .. } => {
                theme::draw_task_section(ui, "Ellipse");
                egui::Grid::new("task_dellip")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "RX");
            ...
            ActiveTask::SurfacePipe { radius, length, .. } => {
                ...
                egui::Grid::new("task_spipe")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "Radius");
                        pmm!(ui, radius, 0.1..=100.0, 0.1, changed);
                        ui.end_row();
                        plabel!(ui, "Length");
                        pmm!(ui, length, 1.0..=500.0, 0.5, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::SurfaceRuled {
                ...
                egui::Grid::new("task_sruled")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "Width");
                        pmm!(ui, width, 0.1..=500.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Depth");
                        pmm!(ui, depth, 0.1..=500.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Offset");
                        pmm!(ui, offset, -100.0..=100.0, 0.5, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::FemMesh { element_size, .. } => {
                theme::draw_task_section(ui, "Mesh Generation");
                egui::Grid::new("task_fem")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "Element Size");
                        pmm!(ui, element_size, 0.1..=50.0, 0.1, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::BooleanOp {
                op_type,
                width,
                height,
                depth,
                ...
                egui::Grid::new("task_bool_shape")
                    ...
                    .show(ui, |ui| {
                        ...
                        ui.end_row();
                        plabel!(ui, "Height");
                        pmm!(ui, height, 0.1..=500.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Depth");
                        pmm!(ui, depth, 0.1..=500.0, 0.5, changed);
                        ui.end_row();
                ...
                egui::Grid::new("task_bool_off")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "X");
                        pmm!(ui, offset_x, -500.0..=500.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Y");
                        pmm!(ui, offset_y, -500.0..=500.0, 0.5, changed);
                        ui.end_row();
                        plabel!(ui, "Z");
                        pmm!(ui, offset_z, -500.0..=500.0, 0.5, changed);
                        ui.end_row();
                    });
            }
            ActiveTask::ScaleOp { factor, .. } => {
                theme::draw_task_section(ui, "Scale");
                egui::Grid::new("task_scale")
                    .num_columns(2)
                    .spacing(grid_sp)
                    .show(ui, |ui| {
                        plabel!(ui, "Factor");
                        pval!(ui, factor, 0.01..=100.0, 0.1, changed);
                        ui.end_row();
                    });
            }
        }
...
pub(crate) fn emit_create_action(gui: &mut GuiState, task: &ActiveTask) {
    match task {
        ...
        ActiveTask::Sphere { radius, .. } => {
            gui.actions
                .push(GuiAction::CreateSphere { radius: *radius });
        }
        ActiveTask::Cone {
            base_radius,
            top_radius,
        ...
        ActiveTask::Hole {
            ...
            if *countersink {
                ...
                gui.actions
                    .push(GuiAction::PartDesign(super::PartDesignAction::HoleSketch {
                        radius: *radius,
                        depth: *depth,
                    }));
            }
        ...
        ActiveTask::Fillet { radius, .. } => {
            gui.actions
                .push(GuiAction::FilletAllEdges { radius: *radius });
        }
        ActiveTask::Chamfer { distance, .. } => {
        ...
        ActiveTask::DraftCircle { .. } => {
            gui.actions
                .push(GuiAction::Draft(super::DraftAction::Circle));
        }
        ActiveTask::DraftRectangle { .. } => {
            gui.actions
                .push(GuiAction::Draft(super::DraftAction::Rectangle));
        }
        ActiveTask::DraftPolygon { .. } => {
            gui.actions
                .push(GuiAction::Draft(super::DraftAction::Polygon));
        }
        ActiveTask::DraftArc { .. } => {
        ...
        ActiveTask::DraftEllipse { .. } => {
            gui.actions
                .push(GuiAction::Draft(super::DraftAction::Ellipse));
        }
        ActiveTask::SurfacePipe { .. } => {
            gui.actions
                .push(GuiAction::Surface(super::SurfaceAction::Pipe));
        }
        ActiveTask::SurfaceRuled { .. } => {
            gui.actions
                .push(GuiAction::StatusMessage("Ruled surface created".into()));
        }
        ActiveTask::FemMesh { element_size, .. } => {
            gui.actions
