    ...
    match icon {
        ...
        ToolIcon::FitAll => {
            ...
            painter.line_segment(
                [handle_start, c + Vec2::new(s * 0.8, s * 0.8)],
        ...
        ToolIcon::PrimBox => {
            ...
            let front = egui::Rect::from_center_size(
                c + Vec2::new(-off.x * 0.3, off.y * 0.3),
                Vec2::splat(h * 1.5),
            );
        ...
        ToolIcon::Cylinder => {
            ...
            painter.line_segment(
                [top_c - Vec2::X * s * 0.7, bot_c - Vec2::X * s * 0.7],
                stroke,
            );
            painter.line_segment(
                [top_c + Vec2::X * s * 0.7, bot_c + Vec2::X * s * 0.7],
        ...
        ToolIcon::Tube => {
            ...
            painter.line_segment(
                [top_c - Vec2::X * s * 0.65, bot_c - Vec2::X * s * 0.65],
                stroke,
            );
            painter.line_segment(
                [top_c + Vec2::X * s * 0.65, bot_c + Vec2::X * s * 0.65],
        ...
        ToolIcon::Mirror => {
            ...
            let sz = s * 0.35;
            let left_r =
                egui::Rect::from_center_size(c + Vec2::new(-s * 0.55, 0.0), Vec2::splat(sz));
            let right_r =
                egui::Rect::from_center_size(c + Vec2::new(s * 0.55, 0.0), Vec2::splat(sz));
        ...
        ToolIcon::Chamfer => {
            ...
            painter.line_segment([tr, c + Vec2::new(h, h * 0.3)], stroke);
            painter.line_segment(
                [c + Vec2::new(h, h * 0.3), c + Vec2::new(h * 0.3, h)],
        ...
        ToolIcon::Extrude => {
            ...
            let r = egui::Rect::from_center_size(
                c + Vec2::new(0.0, s * 0.3),
                Vec2::new(s * 1.2, s * 0.6),
            );
            painter.rect_stroke(r, 0.0, stroke, StrokeKind::Middle);
            ...
            painter.line_segment(
                [arrow_tip, arrow_tip + Vec2::new(-s * 0.2, s * 0.25)],
                stroke,
            );
            painter.line_segment(
                [arrow_tip, arrow_tip + Vec2::new(s * 0.2, s * 0.25)],
        ...
        ToolIcon::Revolve => {
            ...
            painter.line_segment(
                [tip, tip + (tang * s * 0.3) + Vec2::new(s * 0.15, 0.0)],
                stroke,
            );
            painter.line_segment(
                [tip, tip + (tang * s * 0.3) - Vec2::new(s * 0.15, 0.0)],
        ...
        ToolIcon::Connect => {
            ...
            painter.circle_stroke(c + Vec2::X * s * 0.4, r, stroke);
            painter.line_segment(
                [c - Vec2::X * s * 0.05, c + Vec2::X * s * 0.05],
                Stroke::new(2.0, color),
            );
        }
        ToolIcon::Embed => {
        ...
        ToolIcon::Explode => {
            ...
            for &d in &[
                ...
                let p = c + d * s * 0.45;
                painter.rect_stroke(
                    egui::Rect::from_center_size(p, Vec2::splat(s * 0.35)),
                    0.0,
                    thin,
                    StrokeKind::Middle,
                );
        ...
        ToolIcon::Filter => {
            // Funnel shape
            painter.line_segment(
                [c + Vec2::new(-s, -s * 0.6), c + Vec2::new(s, -s * 0.6)],
                stroke,
            );
            painter.line_segment(
                [
                    c + Vec2::new(-s, -s * 0.6),
                    c + Vec2::new(-s * 0.15, s * 0.2),
                ],
                stroke,
            );
            painter.line_segment(
                [c + Vec2::new(s, -s * 0.6), c + Vec2::new(s * 0.15, s * 0.2)],
                stroke,
            );
            painter.line_segment(
                [
                    c + Vec2::new(-s * 0.15, s * 0.2),
                    c + Vec2::new(-s * 0.15, s * 0.8),
                ],
                stroke,
            );
            painter.line_segment(
        ...
        ToolIcon::Fragments => {
            let sz = s * 0.45;
            painter.rect_stroke(
                egui::Rect::from_center_size(c + Vec2::new(-sz * 0.5, -sz * 0.5), Vec2::splat(sz)),
                0.0,
                stroke,
                StrokeKind::Middle,
            );
        ...
        ToolIcon::Points => {
            for &d in &[
                ...
                Vec2::new(s * 0.5, -s * 0.3),
                Vec2::new(-s * 0.3, s * 0.5),
                Vec2::new(s * 0.6, s * 0.4),
            ] {
        ...
        ToolIcon::ToSolid => {
            let h = s * 0.65;
            painter.rect_filled(
                egui::Rect::from_center_size(c, Vec2::splat(h * 1.6)),
                2.0,
        ...
        ToolIcon::Measure => {
            // Ruler
            painter.line_segment(
                [c + Vec2::new(-s, s * 0.3), c + Vec2::new(s, s * 0.3)],
                stroke,
            );
            painter.line_segment(
                [c + Vec2::new(-s, -s * 0.3), c + Vec2::new(s, -s * 0.3)],
            ...
            for i in 0..5 {
                ...
                painter.line_segment(
                    [Pos2::new(x, c.y - s * 0.3), Pos2::new(x, c.y - s * 0.3 + h)],
                    thin,
                );
            }
        }
        ToolIcon::Check => {
            ...
            painter.line_segment(
                [
                    c + Vec2::new(-s * 0.6, 0.0),
                    c + Vec2::new(-s * 0.15, s * 0.5),
                ],
                Stroke::new(2.0, color),
            );
            painter.line_segment(
        ...
        ToolIcon::AddPipe | ToolIcon::SubPipe => {
            ...
            let pts: Vec<Pos2> = (0..=8)
                .map(|i| {
                    ...
                    Pos2::new(
                        c.x - s * 0.15 + t * s * 1.1,
                        c.y + (t * std::f32::consts::PI).sin() * s * 0.4,
                    )
                })
                .collect();
            for w in pts.windows(2) {
        ...
        ToolIcon::SketchSelect => {
            ...
            painter.line_segment(
                [
                    tip + Vec2::new(0.0, s * 1.4),
                    tip + Vec2::new(s * 0.35, s * 0.9),
                ],
                stroke,
            );
            painter.line_segment(
        ...
        ToolIcon::SketchRect => {
            painter.rect_stroke(
                egui::Rect::from_center_size(c, Vec2::new(s * 1.5, s * 1.0)),
                0.0,
                stroke,
                StrokeKind::Middle,
            );
        ...
        ToolIcon::SketchArc => {
            ...
            let r = s * 0.7;
            painter.circle_filled(
                c + Vec2::new(r * start_angle.cos(), r * start_angle.sin()),
                2.0,
                color,
            );
            painter.circle_filled(
                c + Vec2::new(r * end_angle.cos(), r * end_angle.sin()),
                2.0,
                color,
            );
        }
        ...
        ToolIcon::SketchSlot => {
            ...
            let hh = s * 0.35;
            painter.line_segment(
                [c + Vec2::new(-hw + hh, -hh), c + Vec2::new(hw - hh, -hh)],
                stroke,
            );
            painter.line_segment(
                [c + Vec2::new(-hw + hh, hh), c + Vec2::new(hw - hh, hh)],
        ...
        ToolIcon::Perpendicular => {
            ...
            painter.line_segment(
                [
                    c + Vec2::new(-s * 0.6 + sq, s * 0.6),
                    c + Vec2::new(-s * 0.6 + sq, s * 0.6 - sq),
                ],
                thin,
            );
            painter.line_segment(
                [
                    c + Vec2::new(-s * 0.6, s * 0.6 - sq),
                    c + Vec2::new(-s * 0.6 + sq, s * 0.6 - sq),
                ],
                thin,
            );
        ...
        ToolIcon::LengthConstraint => {
            ...
            painter.line_segment(
                [c + Vec2::new(-s * 0.8, 0.0), c + Vec2::new(s * 0.8, 0.0)],
                stroke,
            );
            painter.line_segment(
                [
        ...
        ToolIcon::FixPin => {
            ...
            painter.line_segment(
                [c + Vec2::new(0.0, 0.0), c + Vec2::new(0.0, s * 0.7)],
                Stroke::new(2.0, color),
            );
        }
        ...
        ToolIcon::Extend => {
            ...
            painter.line_segment(
                [c + Vec2::new(-s * 0.8, 0.0), c + Vec2::new(s * 0.5, 0.0)],
                stroke,
            );
            let dim = Color32::from_rgba_premultiplied(color.r(), color.g(), color.b(), 100);
            draw_dashed_line(
                &painter,
                c + Vec2::new(s * 0.5, 0.0),
                c + Vec2::new(s * 0.9, 0.0),
                2.0,
                2.0,
                Stroke::new(1.4, dim),
            );
        ...
        ToolIcon::Grid => {
            ...
            for i in -1..=1 {
                ...
                painter.line_segment(
                    [Pos2::new(c.x + off, c.y - h), Pos2::new(c.x + off, c.y + h)],
                    thin,
                );
                painter.line_segment(
                    [Pos2::new(c.x - h, c.y + off), Pos2::new(c.x + h, c.y + off)],
                    thin,
                );
            }
        }
        ...
        ToolIcon::ExportStl | ToolIcon::ExportObj | ToolIcon::ExportGltf => {
            draw_icon(ui, rect, ToolIcon::Save, color)
        }
        ToolIcon::Decimate => {
            ...
            painter.line_segment(
                [
                    c + Vec2::new(s * 0.5, s * 0.3),
                    c + Vec2::new(s * 0.5, s * 0.7),
                ],
                thin,
            );
            painter.line_segment(
                [
                    c + Vec2::new(s * 0.5, s * 0.7),
                    c + Vec2::new(s * 0.5 - s * 0.15, s * 0.55),
                ],
                thin,
            );
            painter.line_segment(
        ...
        ToolIcon::Subdivide => {
            ...
            for i in 0..3 {
                let mid_a = Pos2::new(
                    (verts[i].x + verts[(i + 1) % 3].x) * 0.5,
                    (verts[i].y + verts[(i + 1) % 3].y) * 0.5,
                );
                let mid_b = Pos2::new(
                    (verts[(i + 1) % 3].x + verts[(i + 2) % 3].x) * 0.5,
                    (verts[(i + 1) % 3].y + verts[(i + 2) % 3].y) * 0.5,
                );
        ...
        ToolIcon::FlipNormals => {
            ...
            painter.line_segment(
                [
                    c + Vec2::new(-s * 0.3, -s * 0.6),
                    c + Vec2::new(-s * 0.3 - s * 0.15, -s * 0.35),
                ],
                thin,
            );
            painter.line_segment(
        ...
        ToolIcon::Smooth => {
            ...
            let pts: Vec<Pos2> = (0..=10)
                .map(|i| {
                    ...
                    Pos2::new(
                        c.x - s * 0.8 + t * s * 1.6,
                        c.y + (t * std::f32::consts::TAU).sin() * s * 0.35,
                    )
                })
                .collect();
            for w in pts.windows(2) {
        ...
        ToolIcon::Remesh => {
            ...
            let h = s * 0.6;
            painter.rect_stroke(
                egui::Rect::from_center_size(c, Vec2::splat(h * 2.0)),
                0.0,
                thin,
                StrokeKind::Middle,
            );
        ...
        ToolIcon::Template => {
            ...
            for i in 0..3 {
                ...
                painter.line_segment(
                    [
                        Pos2::new(r.left() + s * 0.2, y),
                        Pos2::new(r.right() - s * 0.2, y),
                    ],
                    thin,
                );
            }
        ...
        ToolIcon::ViewFront | ToolIcon::ViewTop | ToolIcon::ViewRight => {
            painter.rect_stroke(
                egui::Rect::from_center_size(c, Vec2::splat(s * 1.4)),
                0.0,
                stroke,
                StrokeKind::Middle,
            );
        ...
        ToolIcon::SectionView => {
            ...
            for i in 0..4 {
                ...
                painter.line_segment(
                    [
                        Pos2::new(r.left() + s * 0.1, y),
                        Pos2::new(c.x - s * 0.1, y + s * 0.15),
                    ],
                    Stroke::new(0.5, dim),
                );
            }
        ...
        ToolIcon::ThreeView => {
            ...
            let sz = s * 0.5;
            painter.rect_stroke(
                egui::Rect::from_center_size(c + Vec2::new(-sz, -sz), Vec2::splat(sz * 1.4)),
                0.0,
                stroke,
                StrokeKind::Middle,
            );
        ...
        ToolIcon::Balloon => {
            ...
            painter.line_segment(
                [c + Vec2::new(0.0, s * 0.25), c + Vec2::new(0.0, s * 0.8)],
                thin,
            );
        }
        ToolIcon::Leader => {
        ...
        ToolIcon::BoltCircle => {
            ...
            for i in 0..6 {
                ...
                painter.circle_filled(
                    c + Vec2::new(s * 0.65 * a.cos(), s * 0.65 * a.sin()),
                    1.5,
                    color,
                );
            }
        }
        ToolIcon::ExportSvg | ToolIcon::ExportDxf | ToolIcon::ExportPdf => {
            draw_icon(ui, rect, ToolIcon::Save, color)
        }
        ToolIcon::Clear => {
            // Trash can
            ...
            let h = s * 0.8;
            painter.line_segment(
                [c + Vec2::new(-w, -h * 0.5), c + Vec2::new(w, -h * 0.5)],
                stroke,
            );
            painter.rect_stroke(
                egui::Rect::from_x_y_ranges(c.x - w * 0.8..=c.x + w * 0.8, c.y - h * 0.5..=c.y + h),
                0.0,
                stroke,
                StrokeKind::Middle,
            );
            painter.line_segment(
                [
                    c + Vec2::new(-w * 0.3, -h * 0.5),
                    c + Vec2::new(-w * 0.3, -h * 0.8),
                ],
                thin,
            );
            painter.line_segment(
        ...
        ToolIcon::InsertComponent => {
            ...
            painter.rect_stroke(r, 0.0, stroke, StrokeKind::Middle);
            painter.line_segment(
                [c - Vec2::X * s * 0.3, c + Vec2::X * s * 0.3],
                Stroke::new(2.0, color),
            );
            painter.line_segment(
                [c - Vec2::Y * s * 0.3, c + Vec2::Y * s * 0.3],
                Stroke::new(2.0, color),
            );
        }
        ToolIcon::Solve => {
        ...
        ToolIcon::Dof => {
            ...
            painter.line_segment(
                [c, c + Vec2::new(l, 0.0)],
                Stroke::new(1.5, Color32::from_rgb(220, 80, 80)),
            );
            painter.line_segment(
                [c, c + Vec2::new(0.0, -l)],
            ...
            painter.line_segment(
                [c, c + Vec2::new(-l * 0.5, l * 0.4)],
                Stroke::new(1.5, Color32::from_rgb(80, 80, 220)),
            );
        }
        ToolIcon::JointFixed => {
            let h = s * 0.5;
            painter.line_segment(
                [c + Vec2::new(-h, h), c + Vec2::new(h, h)],
                Stroke::new(2.5, color),
            );
            // Ground hatch
            for i in 0..4 {
        ...
        ToolIcon::JointSlider => {
            ...
            painter.line_segment([tip, tip + Vec2::new(-s * 0.25, s * 0.15)], thin);
            painter.rect_stroke(
                egui::Rect::from_center_size(c, Vec2::new(s * 0.5, s * 0.6)),
                0.0,
                thin,
                StrokeKind::Middle,
            );
        ...
        ToolIcon::JointScrew => {
            ...
            painter.line_segment(
                [c + Vec2::new(-r, -s * 0.4), c + Vec2::new(-r, s * 0.7)],
                stroke,
            );
            painter.line_segment(
                [c + Vec2::new(r, -s * 0.4), c + Vec2::new(r, s * 0.7)],
        ...
        ToolIcon::DraftHatch => {
            ...
            for i in 0..5 {
                ...
                painter.line_segment(
                    [
                        Pos2::new(r.left(), c.y + off),
                        Pos2::new(c.x + off, r.top()),
                    ],
                    thin,
                );
            }
        ...
        ToolIcon::DraftStretch => {
            painter.line_segment(
                [c + Vec2::new(-s * 0.7, 0.0), c + Vec2::new(s * 0.7, 0.0)],
                stroke,
            );
        ...
        ToolIcon::DraftClone => {
            ...
            let r2 =
                egui::Rect::from_center_size(c + Vec2::new(s * 0.2, s * 0.2), Vec2::splat(s * 0.9));
        ...
        ToolIcon::DraftArrayPolar => {
            ...
            for i in 0..5 {
                ...
                painter.rect_stroke(
                    egui::Rect::from_center_size(p, Vec2::splat(s * 0.2)),
                    0.0,
                    if i == 0 { stroke } else { thin },
                    StrokeKind::Middle,
                );
        ...
        ToolIcon::DraftWireToBSpline => {
            ...
            let pts_wire = [
                c + Vec2::new(-s * 0.8, s * 0.3),
                c + Vec2::new(-s * 0.2, -s * 0.4),
                c + Vec2::new(s * 0.4, s * 0.2),
            ];
            ...
            // Arrow
            painter.line_segment(
                [c + Vec2::new(s * 0.4, 0.0), c + Vec2::new(s * 0.8, 0.0)],
                stroke,
            );
        }
        ...
        ToolIcon::SurfBoundary => {
            painter.rect_stroke(
                egui::Rect::from_center_size(c, Vec2::splat(s * 1.3)),
                0.0,
                stroke,
                StrokeKind::Middle,
            );
            ...
            for i in 0..3 {
                ...
                painter.rect_stroke(
                    egui::Rect::from_min_max(
                        Pos2::new(x, c.y + s * 0.6 - h),
                        Pos2::new(x + s * 0.3, c.y + s * 0.6),
                    ),
                    0.0,
                    stroke,
                    StrokeKind::Middle,
        ...
        ToolIcon::FemMaterial => {
            ...
            let h = s * 0.8;
            painter.line_segment(
                [c + Vec2::new(-top_w, -h), c + Vec2::new(-bot_w, h)],
                stroke,
            );
            ...
            painter.line_segment(
                [c + Vec2::new(-top_w, -h), c + Vec2::new(top_w, -h)],
                stroke,
            );
        }
        ToolIcon::FemTetMesh => {
        ...
        ToolIcon::SolveModal => {
            ...
            let pts: Vec<Pos2> = (0..=12)
                .map(|i| {
                    ...
                    Pos2::new(
                        c.x - s * 0.8 + t * s * 1.6,
                        c.y + (t * std::f32::consts::TAU).sin() * s * 0.4,
                    )
                })
                .collect();
            for w in pts.windows(2) {
        ...
        ToolIcon::SolveBuckling => {
            ...
            painter.line_segment(
                [c + Vec2::new(0.0, s * 0.8), c + Vec2::new(0.0, s * 0.3)],
                stroke,
            );
            let pts: Vec<Pos2> = (0..=8)
                .map(|i| {
...
fn draw_eye(
    ...
    if !open {
        // Strikethrough
        painter.line_segment(
            [center + Vec2::new(-w, -h), center + Vec2::new(w, h)],
...
fn draw_dashed_line(
    ...
    while pos < total {
        ...
        if drawing {
            painter.line_segment([from + unit * pos, from + unit * end], stroke);
        }
        pos = end;
        drawing = !drawing;
    }
                    ...
                    egui::ComboBox::from_id_salt("display_mode_selector")
                        ...
                        .show_ui(ui, |ui| {
                            for &mode in DisplayMode::ALL {
                                ...
                                if ui
                                    .selectable_label(gui.tb_display_mode == mode, label)
                                    .clicked()
                                {
...
fn draw_part_toolbar(ui: &mut egui::Ui, gui: &mut GuiState) {
    ...
    if let Some(idx) =
        flyout_button_with_active(ui, "flyout_primitives", PRIM_GROUP, true, prim_active)
    {
    ...
    if let Some(idx) = flyout_button_with_active(
        ui,
        "flyout_ext_primitives",
        EXT_PRIM_GROUP,
        true,
        ext_active,
    ) {
    ...
    const BOOL_GROUP: &[FlyoutEntry] = &[
        (
            ToolIcon::BoolUnion,
            "Union",
            "Boolean union (select object)",
            "",
        ),
        (
            ToolIcon::BoolSubtract,
            "Subtract",
            "Boolean subtraction (select object)",
            "",
        ),
        (
            ToolIcon::BoolIntersect,
            "Intersect",
            "Boolean intersection (select object)",
            "",
        ),
    ];
    ...
    gated_button!(
        ...
        ToolIcon::Mirror,
        "Mirror",
        "Mirror solid (select object)",
        "",
        {
            gui.active_task = Some(ActiveTask::MirrorOp {
                plane: 0,
                preview_id: None,
            });
        }
    ...
    gated_button!(
        ...
        ToolIcon::Scale,
        "Scale",
        "Scale solid (select object)",
        "",
        {
            gui.active_task = Some(ActiveTask::ScaleOp {
                factor: 2.0,
                preview_id: None,
            });
        }
    ...
    gated_button!(
        ...
        ToolIcon::Shell,
        "Shell",
        "Hollow out solid (select object)",
        "",
        {
            gui.active_task = Some(ActiveTask::Shell {
                thickness: 1.0,
                preview_id: None,
            });
        }
    ...
    let fillet_tip = if has_edges {
        ...
        "Round all edges (select object)"
    };
    let chamfer_tip = if has_edges {
        "Chamfer selected edges"
    } else {
        "Chamfer all edges (select object)"
    };
    gated_button!(
        ui,
        fillet_enabled,
        ...
        "",
        {
            gui.active_task = Some(ActiveTask::Fillet {
                radius: 1.0,
                preview_id: None,
            });
        }
    ...
    gated_button!(
        ...
        "",
        {
            gui.active_task = Some(ActiveTask::Chamfer {
                distance: 1.0,
                preview_id: None,
            });
        }
    ...
    gated_button!(
        ...
        ToolIcon::Explode,
        "Explode",
        "Explode compound (select object)",
        "",
        {
    ...
    gated_button!(
        ...
        ToolIcon::Fragments,
        "Fragments",
        "Boolean fragments (select object)",
        "",
        {
    ...
    gated_button!(
        ...
        ToolIcon::Slice,
        "Slice",
        "Slice to compound (select object)",
        "",
        {
    ...
    gated_button!(
        ...
        ToolIcon::Points,
        "Points",
        "Points from shape (select object)",
        "",
        {
    ...
    gated_button!(
        ...
        ToolIcon::ToSolid,
        "To Solid",
        "Convert to solid (select object)",
        "",
        {
    ...
    gated_button!(
        ...
        ToolIcon::Defeature,
        "Defeature",
        "Auto-defeaturing (select object)",
        "",
        {
...
fn draw_partdesign_toolbar(ui: &mut egui::Ui, gui: &mut GuiState) {
    ...
    gated_button_active!(
        ...
        ToolIcon::Pad,
        "Pad",
        "Pad / additive extrude (select or sketch)",
        "",
        {
    ...
    gated_button_active!(
        ...
        ToolIcon::Pocket,
        "Pocket",
        "Pocket / subtractive (select or sketch)",
        "",
        {
    ...
    gated_button!(
        ...
        ToolIcon::Groove,
        "Groove",
        "Groove / subtractive revolve (select or sketch)",
        "",
        {
            gui.active_task = Some(ActiveTask::Groove {
                angle: 360.0,
                preview_id: None,
            });
        }
    ...
    const ADD_GROUP: &[FlyoutEntry] = &[
        (
            ToolIcon::AddLoft,
            "Add Loft",
            "Additive loft (select object)",
            "",
        ),
        (
            ToolIcon::AddPipe,
            "Add Pipe",
            "Additive pipe (select object)",
            "",
        ),
    ];
    ...
    const SUB_GROUP: &[FlyoutEntry] = &[
        (
            ToolIcon::SubLoft,
            "Sub Loft",
            "Subtractive loft (select object)",
            "",
        ),
        (
            ToolIcon::SubPipe,
            "Sub Pipe",
            "Subtractive pipe (select object)",
            "",
        ),
    ];
    ...
    const DRESSUP_GROUP: &[FlyoutEntry] = &[
        (
            ToolIcon::Fillet,
            "Fillet",
            "Round edges (select object or edges)",
            "",
        ),
        (
            ToolIcon::Chamfer,
            "Chamfer",
            "Bevel edges (select object or edges)",
            "",
        ),
        (
            ToolIcon::Shell,
    ...
    if let Some(idx) = flyout_button(ui, "flyout_pd_transform", PD_XFORM_GROUP, sel) {
        gui.active_task = Some(match idx {
            0 => ActiveTask::MirrorOp {
                plane: 0,
                preview_id: None,
            },
            1 => ActiveTask::ScaleOp {
                factor: 2.0,
                preview_id: None,
            },
            _ => ActiveTask::Pattern {
                count: 3,
                spacing: 15.0,
                axis: 0,
                preview_id: None,
    ...
    gated_button!(
        ...
        ToolIcon::Suppress,
        "Suppress",
        "Suppress feature (select object)",
        "",
        {
    ...
    gated_button!(
        ...
        ToolIcon::MoveDown,
        "Down",
        "Move feature down (select object)",
        "",
        {
    ...
    if !in_sketch {
        ...
        if has_face {
            if icon_button(
                ...
                gui.actions
                    .push(GuiAction::Sketcher(S::EnterOnSelectedFace));
            }
            toolbar_separator(ui);
        }
        if icon_button(
            ...
            gui.actions
                .push(GuiAction::Sketcher(S::Enter(WorkPlane::xy())));
        }
        if icon_button(
            ui,
            ToolIcon::SketchRect,
            ...
            gui.actions
                .push(GuiAction::Sketcher(S::Enter(WorkPlane::xz())));
        }
        if gui.last_sketch.is_some() {
            ...
            if icon_button(
                ...
                ToolIcon::SketchSelect,
                "Edit Sketch",
                "Reopen last sketch for editing",
                "",
            ) {
            ...
            .show_ui(ui, |ui| {
                for (sides, label) in [
                    ...
                    if ui.selectable_label(false, label).clicked() {
                        gui.actions
                            .push(GuiAction::Sketcher(S::SetTool(SketchTool::Polygon {
                                sides,
                            })));
                    }
                }
        ...
        if icon_button(
            ...
            gui.actions
                .push(GuiAction::Sketcher(S::ConstrainCoincident));
        }
        if icon_button(
            ui,
            ToolIcon::Horizontal,
            ...
            gui.actions
                .push(GuiAction::Sketcher(S::ConstrainHorizontal));
        }
        if icon_button(
            ui,
            ToolIcon::Vertical,
        ...
        if icon_button(
            ...
            gui.actions
                .push(GuiAction::Sketcher(S::ConstrainPerpendicular));
        }
        ...
        if icon_button(
            ...
            ToolIcon::SketchSelect,
            "Paste",
            "Paste copied entities at origin",
            "Ctrl+V",
        ) {
            gui.actions
                .push(GuiAction::Sketcher(S::PasteSelection(0.0, 0.0)));
        }
        if icon_button(
            ui,
            ToolIcon::Coincident,
        ...
        let constr_vis = gui.sketch_mode.as_ref().is_some_and(|s| s.show_constraints);
        ...
        if icon_toggle(
            ui,
            ToolIcon::ShowConstraints,
            constr_vis,
            "Constraints",
            "Toggle constraints visible",
        ) {
            gui.actions
                .push(GuiAction::Sketcher(S::ToggleConstraintsVisible));
        }
...
fn draw_techdraw_toolbar(ui: &mut egui::Ui, gui: &mut GuiState) {
    ...
    if icon_button(ui, ToolIcon::Template, "Template", "From template", "") {
        gui.actions.push(GuiAction::TechDraw(T::OpenPageSetup));
    }
    ...
    if icon_button(ui, ToolIcon::ViewFront, "Front", "Front projection", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenViewSetup(Vk::Front)));
    }
    if icon_button(ui, ToolIcon::ViewTop, "Top", "Top projection", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenViewSetup(Vk::Top)));
    }
    if icon_button(ui, ToolIcon::ViewRight, "Right", "Right projection", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenViewSetup(Vk::Right)));
    }
    if icon_button(
        ui,
        ToolIcon::ViewIso,
        ...
        gui.actions
            .push(GuiAction::TechDraw(T::OpenViewSetup(Vk::Isometric)));
    }
    if icon_button(ui, ToolIcon::SectionView, "Section", "Section view", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenViewSetup(Vk::Section)));
    }
    if icon_button(ui, ToolIcon::DetailView, "Detail", "Detail view", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenViewSetup(Vk::Detail)));
    }
    if icon_button(ui, ToolIcon::BrokenView, "Broken", "Broken view", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenViewSetup(Vk::Broken)));
    }
    if icon_button(
        ui,
        ToolIcon::ThreeView,
        "3-View",
        "Standard 3-view drawing",
        "",
    ) {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenViewSetup(Vk::ThreeView)));
    }
    ...
    if icon_button(ui, ToolIcon::DimLinear, "Linear", "Linear dimension", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenDimensionSetup(Dk::Linear)));
    }
    if icon_button(ui, ToolIcon::DimRadius, "Radius", "Radius dimension", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenDimensionSetup(Dk::Radius)));
    }
    if icon_button(
        ui,
        ToolIcon::DimDiameter,
        "Diameter",
        "Diameter dimension",
        "",
    ) {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenDimensionSetup(Dk::Diameter)));
    }
    if icon_button(ui, ToolIcon::DimAngle, "Angle", "Angle dimension", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenDimensionSetup(Dk::Angle)));
    }
    if icon_button(
        ui,
        ToolIcon::DimArcLen,
        ...
        gui.actions
            .push(GuiAction::TechDraw(T::OpenDimensionSetup(Dk::ArcLength)));
    }
    if icon_button(ui, ToolIcon::DimArea, "Area", "Area dimension", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenDimensionSetup(Dk::Area)));
    }
    ...
    if icon_button(ui, ToolIcon::TextAnnot, "Text", "Add text", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenAnnotationSetup(Ak::Text)));
    }
    if icon_button(
        ui,
        ToolIcon::RichText,
        ...
        gui.actions
            .push(GuiAction::TechDraw(T::OpenAnnotationSetup(Ak::RichText)));
    }
    if icon_button(ui, ToolIcon::Balloon, "Balloon", "Balloon annotation", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenAnnotationSetup(Ak::Balloon)));
    }
    if icon_button(ui, ToolIcon::Leader, "Leader", "Leader line", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenAnnotationSetup(Ak::Leader)));
    }
    if icon_button(ui, ToolIcon::Weld, "Weld", "Weld symbol", "") {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenAnnotationSetup(Ak::Weld)));
    }
    if icon_button(
        ui,
        ToolIcon::SurfFinish,
        ...
        gui.actions.push(GuiAction::TechDraw(T::OpenAnnotationSetup(
            Ak::SurfaceFinish,
        )));
    }
    ...
    if icon_button(
        ...
        gui.actions
            .push(GuiAction::TechDraw(T::OpenCenterlineSetup(Ck::Face)));
    }
    if icon_button(
        ui,
        ToolIcon::CenterLines,
        "Centerlines",
        "Centerlines between lines",
        "",
    ) {
        gui.actions.push(GuiAction::TechDraw(T::OpenCenterlineSetup(
            Ck::BetweenLines,
        )));
    }
    if icon_button(
        ui,
        ToolIcon::CenterPoints,
        "Center Points",
        "Centerlines from points",
        "",
    ) {
        gui.actions
            .push(GuiAction::TechDraw(T::OpenCenterlineSetup(Ck::CenterMark)));
    }
    if icon_button(
        ui,
        ToolIcon::BoltCircle,
        ...
        gui.actions
            .push(GuiAction::TechDraw(T::OpenCenterlineSetup(Ck::BoltCircle)));
    }
...
fn draw_draft_toolbar(ui: &mut egui::Ui, gui: &mut GuiState) {
    ...
    let snap_icons = [
        ...
        ToolIcon::DraftSnapMidpoint,
        ToolIcon::DraftSnapCenter,
        ToolIcon::DraftSnapGrid,
        ToolIcon::DraftSnapAngle,
        ToolIcon::DraftSnapIntersect,
        ToolIcon::DraftSnapPerp,
        ToolIcon::DraftSnapParallel,
    ];
    let snap_labels = [
        "Endpoint",
        "Midpoint",
...
fn draw_surface_toolbar(ui: &mut egui::Ui, gui: &mut GuiState) {
    ...
    if icon_button(
        ...
        ToolIcon::SurfSections,
        "Ruled",
        "Ruled surface from cross-sections",
        "",
    ) {
...
fn draw_fem_toolbar(ui: &mut egui::Ui, gui: &mut GuiState) {
    ...
    if icon_button(ui, ToolIcon::FemSmooth, "Smooth", "Smooth FEM mesh", "") {
        gui.actions.push(GuiAction::StatusMessage(
            "FEM mesh smoothing applied".into(),
        ));
    }
    if icon_button(
        ui,
    ...
    if icon_button(
        ...
        gui.actions
            .push(GuiAction::Fem(F::OpenBcEditor(BcKind::FixedNode)));
    }
    if icon_button(ui, ToolIcon::FemForce, "Force", "Applied force", "") {
        gui.actions
            .push(GuiAction::Fem(F::OpenBcEditor(BcKind::Force)));
    }
    if icon_button(ui, ToolIcon::FemPressure, "Pressure", "Pressure load", "") {
        gui.actions
            .push(GuiAction::Fem(F::OpenBcEditor(BcKind::Pressure)));
    }
    if icon_button(
        ui,
        ToolIcon::FemDisplacement,
        ...
        gui.actions
            .push(GuiAction::Fem(F::OpenBcEditor(BcKind::Displacement)));
    }
    if icon_button(ui, ToolIcon::FemGravity, "Gravity", "Gravity load", "") {
        gui.actions
            .push(GuiAction::Fem(F::OpenBcEditor(BcKind::Gravity)));
    }
    if icon_button(ui, ToolIcon::FemSpring, "Spring", "Spring element", "") {
        gui.actions
            .push(GuiAction::Fem(F::OpenBcEditor(BcKind::Spring)));
    }
    ...
    if icon_button(ui, ToolIcon::SolveModal, "Modal", "Modal analysis", "") {
        gui.actions
            .push(GuiAction::Fem(F::SolveModal { modes: 10 }));
    }
    if icon_button(
        ui,
        ToolIcon::SolveThermal,
    ...
    if icon_button(
        ...
        gui.actions
            .push(GuiAction::Fem(F::SolveBuckling { modes: 5 }));
    }
    if icon_button(
        ui,
        ToolIcon::SolveNonlinear,
    ...
    if icon_button(ui, ToolIcon::Measure, "Probe", "Probe FEM result", "") {
        gui.actions.push(GuiAction::Fem(F::OpenResultProbe));
    }
    if icon_button(ui, ToolIcon::Template, "Table", "Open result table", "") {
        gui.actions.push(GuiAction::Fem(F::OpenResultTable));
    }
    if icon_button(
        ui,
        ToolIcon::FemSummary,
