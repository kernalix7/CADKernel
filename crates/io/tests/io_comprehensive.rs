...
//!
//! Covers parser error paths, mesh_ops public API, tessellate edge cases,
//! SVG/PDF content validation, native format error handling, and techdraw
//! projection APIs. MCP server coverage lives in `crates/mcp/tests/` since
//! the server moved to the `cadkernel-mcp` crate.
//!
