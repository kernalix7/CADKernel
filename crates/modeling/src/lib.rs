...
pub use features::{
    ...
    boolean_fragments, chamfer_edge, chamfer_edges, circular_pattern, compound_filter, connect_shapes,
    ...
    fillet_edge, fillet_edge_segments, fillet_edges, groove, hole, linear_pattern, loft, mirror_solid,
